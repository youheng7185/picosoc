...
module axi_interconnect (
    ...
    localparam [31:0] MDIO                 = 32'h80000400;
    localparam [31:0] PERIPH_MASK_256  = 32'hFFFF_FF00;
    localparam [31:0] PERIPH_MASK_4K   = 32'hFFFF_F000;

    // =====================================================
    // Slave selection signals (7 slaves)
    // =====================================================
    reg [6:0] aw_slave_sel;
    reg [6:0] ar_slave_sel;
    ...
    function [6:0] decode_addr;
        ...
        begin
            ...
            if ((addr >= INSTR_MEM)
                ...
                sel[5] = 1'b1;
            else if ((addr & PERIPH_MASK_256) == MDIO)
                sel[6] = 1'b1;
            decode_addr = sel;
        end
    endfunction
    ...
    assign s6_axi_wvalid = m_axi_wvalid & write_slave_sel[6];
    ...
    assign m_axi_wready = !write_w_seen_q &&
                          ((s0_axi_wready & write_slave_sel[0]) |
                           ...
                           (s6_axi_wready & write_slave_sel[6]) |
    ...
    assign m_axi_bvalid = s0_axi_bvalid | s1_axi_bvalid | s2_axi_bvalid | s3_axi_bvalid |
                          s4_axi_bvalid | s5_axi_bvalid | s6_axi_bvalid |
                          default_bvalid_q;
    ...
    assign m_axi_rvalid = s0_axi_rvalid | s1_axi_rvalid | s2_axi_rvalid | s3_axi_rvalid |
                          s4_axi_rvalid | s5_axi_rvalid | s6_axi_rvalid |
                          default_rvalid_q;
